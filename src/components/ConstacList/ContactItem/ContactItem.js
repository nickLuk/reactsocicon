...
class ContactItem extends React.Component {
    ...
    render() {
        const { avatar, description, name, gender, iconfacebook, icontwitter, iconlinkedin, iconskype, iconemail } = this.state;
                        ...
                        >
                            ...
                            <div className="clearfix">
                                ...
                                <ul className="social-links list-inline p-b-10 col-5">
                                    ...
                                    <li>
                                        <div className={starStyle} onClick={this.StarInsert}><i className="fa fa-star" ></i></div>
                                    </li>
